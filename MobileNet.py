...
def runMobileNet(path):
    config = tf.compat.v1.ConfigProto()
    config.gpu_options.allow_growth = True
    session = InteractiveSession(config=config)

    # załadowanie pretrenowanego modelu
    preTrainedModel = MobileNet(include_top=True, weights='imagenet', input_tensor=None, input_shape=None, pooling=None)
...
# runMobileNet('C:/Users/pawel/Desktop/border.jpg')